    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.attendances-reports.update", [$attendancesReport->id]) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control timepicker" type="text" name="check_in" id="check_in" value="{{ old('check_in', $attendancesReport->check_in) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control timepicker" type="text" name="check_out" id="check_out" value="{{ old('check_out', $attendancesReport->check_out) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="location" id="location" value="{{ old('location', $attendancesReport->location) }}">
